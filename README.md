...
**https://purser-production-c360.up.railway.app** · the full control room, hosted on Railway in simulate mode (no keys on the host; the ledger ships seeded with the canonical run incl. the ACP earning). Wipe is public too: that's the amnesia demo, it reseeds by running the litmus.
